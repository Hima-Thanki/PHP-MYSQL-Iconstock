...
<?php
      ...
      if(isset($_GET['style']))
      {
          $query = "select * from item where i_type='a' and i_style='".$_GET['style']."'";
      }
      else
      {
      $query = "select * from item where i_type='a'";
      }      
    ...
    <section class="u-clearfix u-white u-section-1" id="sec-5cd5">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 style="text-align: center; font-weight: bold;" class="u-text u-text-default u-text-1">Animated Icons </h1>
        <div class="u-form u-form-1">
          ...
          <div class="u-form-group u-form-select u-label-none u-form-group-1" style="padding:10px;width:650px">
            ...
            <input style="margin-left: 20px;" type="submit" value="Filter" name="filtera" class="u-border-2 u-border-black u-btn u-btn-submit u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-1">
            
            <a href="reset.php?r=a" name="reset" style="margin-left: 20px;" class="u-border-2 u-border-black u-btn u-btn-submit u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-1">reset</a>
        </form>
        </div>
