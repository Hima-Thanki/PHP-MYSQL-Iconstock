...
?>
    ...
    <form action="adminserver.php" method="post">
      ...
      <br>
      <div class="input-group">
        <button style="background-color: #000080; color: white; font-weight: bold;" type="submit" name="register-admin" class="btn-reg">Register</button>
      </div>

      <h5 align="center" id="register">Already registered ..? <a style="color: #000080;" href="adminlogin.php">Login</a></h5>
    </form>
  </div>
   </section>
