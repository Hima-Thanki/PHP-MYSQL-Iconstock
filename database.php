...
<link rel="stylesheet" href="social-media.css" media="screen">
  ...
  <body class="u-body u-xl-mode" data-lang="en">
    ...
    <?php
      ...
      if(isset($_GET['style']))
      {
          $query = "select * from item where i_cat='db' and i_style='".$_GET['style']."'";
      }
      else
      {
      $query = "select * from item where i_cat='db'";
      }      
      ...
      <div class="u-form u-form-1" style="background-image: linear-gradient(to bottom right, lightblue,lightpink,lawngreen); width: 100%;padding: 30px 200px 30px 200px;margin: 0;">
       <form action="fillter.php" method="POST" class="u-clearfix u-form-spacing-50 u-inner-form" style="display: flex;flex-flow: row;align-items: center;flex-grow: 1;">
          <div class="u-form-group u-form-select u-label-none u-form-group-1" style="padding:10px;width:650px">
            ...
            <input style="margin-left: 20px;" type="submit" value="Filter" name="filterdb" class="u-border-2 u-border-black u-btn u-btn-submit u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-1">
            <a href="reset.php?r=db" name="reset" style="margin-left: 20px;" class="u-border-2 u-border-black u-btn u-btn-submit u-button-style u-hover-black u-none u-text-black u-text-hover-white u-btn-1">reset</a>
        </form>
      </div>
